        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <nav class="nav nav-tabs">
                    <a href="{{route('ai_software.view', $ai_tool->slug)}}" class="nav-item nav-link nav-tab-menu active">
                        <i class="fa fa-home"></i> Alternatives
                    </a>
                    <a href="{{route('ai_software.reviews', $ai_tool->slug)}}" class="nav-item nav-tab-menu nav-link">
                        <i class="fa fa-user"></i> Reviews
                    </a>
                </nav>
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <h3 class="ai-software-header float-left">Alternative Software of {{$ai_tool->name}} ...</h3>
                    </div>
                        ...
                        <div class="col-md-4 mb-2">
                            <div class="card ai-software-card-width">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-center"><a class="ai-software-card-head" href="{{route('ai_software.view', $ai_tool_alternative->slug)}}">{{$ai_tool_alternative->name}}</a></h5>
