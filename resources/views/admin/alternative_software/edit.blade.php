...
@section('content')
    <div class="container mt-2">
        <div class="row">
            <div class="col-md-12">
                Here you will view all software. <a href="{{route('alternative_software.index')}}">view software</a>
            ...
            <div class="col-md-12">
                <div class="alert alert-success">
                    <h5>Edit Software</h5>
                    <form action="{{route('alternative_software.update', $alternative_software->id)}}" method="post" enctype="multipart/form-data">
                        @csrf @method('put')
