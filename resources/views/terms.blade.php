...
@section('title') Terms and Conditions | Ai Online Course @endsection

@section('content')
    @include('includes.header')
    <div class="row">
        <div class="col-md-10 offset-md-1 terms">
            <h1 class="text-center mb-5">Terms and Conditions </h1>
            <p>Please read these terms and conditions carefully before using the aionlinecourse.com website operated by the name of aionlinecourse.com.</p>
            ...
            <h4>Copyright</h4>
            <p>All files and information contained in this Website or Blog are copyright by Namespace IT, and may not be duplicated, copied, modified or adapted, in any way without our written permission. Our Website may contain our service marks or trademarks as well as those of our affiliates or other companies, in the form of words, graphics, and logos.
                Your use of our Website, Blog, or Services does not constitute any right or license for you to use our service marks or trademarks, without the prior written permission of aionlinecourse.com.
            ...
            <p>By visiting this website, you agree that the laws of your location, without regard to principles of conflict laws, will govern these terms and conditions, or any dispute of any sort that might come between [name] and you, or its business partners and associates.</p>
            <h4>Disputes</h4>
